...
export function PageHeader({
  ...
  return (
    <header className="relative overflow-hidden rounded-[26px] border border-[var(--border-soft)] bg-[linear-gradient(135deg,rgba(255,255,255,0.52),rgba(255,255,255,0.20))] px-4 py-5 shadow-[0_12px_30px_rgba(87,58,33,0.05)] sm:px-5 lg:px-6 xl:px-7">
      <div
      ...
      <div className="relative z-[1] flex flex-col gap-4 xl:flex-row xl:items-end xl:justify-between">
        <div className="min-w-0 space-y-3">
          ...
          <div className="max-w-[76rem]">
            <h2 className="theme-font-display text-[2.4rem] leading-[0.98] tracking-tight text-[var(--text-1)] sm:text-[2.8rem] md:text-[3.1rem] min-[1700px]:max-w-[14ch] xl:text-[3rem]">
              {title}
            </h2>
