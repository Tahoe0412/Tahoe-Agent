...
-- CreateEnum
CREATE TYPE "LlmProvider" AS ENUM ('OPENAI', 'GEMINI', 'DEEPSEEK', 'QWEN');
...
-- CreateIndex
CREATE INDEX "scene_classifications_project_id_production_class_difficult_idx" ON "scene_classifications"("project_id", "production_class", "difficulty_score");

-- CreateIndex
CREATE INDEX "scene_classifications_project_id_human_type_motion_type_lip_idx" ON "scene_classifications"("project_id", "human_type", "motion_type", "lip_sync_type");

-- CreateIndex
CREATE UNIQUE INDEX "scene_classifications_script_scene_id_classification_versio_key" ON "scene_classifications"("script_scene_id", "classification_version");
