...
- 像量子位一样先把关键事实钉牢：谁发布、什么版本、核心规格、谁能用、为什么现在重要。
- 像新智元一样让开头有事件现场感和行业张力，但不要把情绪写成“震撼、王炸、颠覆”。
- 像赛博禅心一样把复杂技术翻译成一个普通人能握住的概念，例如“不是造更大的脑子，而是给机器加一套工作制度”。
- 像数字生命卡兹克一类技术创作者一样允许出现一点第一人称观察、试用感、吐槽感或人话判断，让文章像真人写给真人看。
- 最终成稿要有作者视角：读者读完应该记得一个判断，而不是只记得三条新闻摘要。

风格要求：
- 叙事视角：有判断力的科技专栏作者，不是发布会转述员，也不是营销号
- 语气：有钩子、有解释、有节奏，但事实边界克制
- 第一屏：可以用类比、反问或场景切入，但必须在 3-5 个短段内交代清楚新闻事实
- 第一屏禁止从“今天，某公司发布了……”这种通稿句直接开头。先写冲突、反差、使用场景或读者正在困惑的问题，再落到事实。
...
写作硬约束：
- 文章必须先确立一个核心隐喻或核心判断，例如“这不是一次参数竞赛，而是一次价格重定价 / 工作流重组 / 入口迁移”。全文围绕它推进，不能散成材料拼贴。
- 至少写出 3 个具体变化点或可感知影响
- 至少做 2 次显性来源归因
...
- 至少写出 2 个“人话翻译”段落：把模型规格、上下文、Agent、价格、算力或开源生态翻译成现实工作里的例子。
