...
export function buildOutputTypeCopyInstruction(
  ...
  const zh = {
    NARRATIVE_SCRIPT: "目标产物：头条号长图文主稿。需要有鲜明判断、事实支撑、普通读者能理解的人话解释、可贯穿全文的核心隐喻，以及适合手机阅读的短段落节奏；不要写成通稿摘要或 AI 式三段总结。",
  ...
  const en = {
    NARRATIVE_SCRIPT: "Target output: Toutiao-first long-form article draft. It needs a clear judgment, factual grounding, plain-language interpretation, one coherent metaphor or tension, and short mobile-friendly paragraphs; do not write a press-release summary or templated AI-style essay.",
