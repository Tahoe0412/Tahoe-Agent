        ...
        >
          <div className="grid gap-4 md:grid-cols-2">
            <div className="rounded-md bg-[var(--surface-muted)] p-4">
              <div className="text-xs font-semibold uppercase tracking-[0.12em] text-[var(--text-3)]">Access</div>
            ...
            <div className="rounded-md bg-[var(--surface-muted)] p-4">
              <div className="text-xs font-semibold uppercase tracking-[0.12em] text-[var(--text-3)]">Storage</div>
              <div className="mt-2 text-sm leading-7 text-[var(--text-2)]">
                {locale === "en"
          ...
          <div className="grid gap-4 md:grid-cols-3">
            <div className="rounded-md bg-[var(--surface-muted)] p-4">
              <div className="text-xs font-semibold uppercase tracking-[0.12em] text-[var(--text-3)]">{locale === "en" ? "Must Have" : "必配项"}</div>
              <div className="mt-2 text-sm leading-7 text-[var(--text-2)]">
                {locale === "en"
            ...
            <div className="rounded-md bg-[var(--surface-muted)] p-4">
              <div className="text-xs font-semibold uppercase tracking-[0.12em] text-[var(--text-3)]">{locale === "en" ? "Recommended" : "建议项"}</div>
              <div className="mt-2 text-sm leading-7 text-[var(--text-2)]">
                {locale === "en"
            ...
            <div className="rounded-md bg-[var(--surface-muted)] p-4">
              <div className="text-xs font-semibold uppercase tracking-[0.12em] text-[var(--text-3)]">{locale === "en" ? "Before Wider Sharing" : "扩大共享前"}</div>
              <div className="mt-2 text-sm leading-7 text-[var(--text-2)]">
                {locale === "en"
